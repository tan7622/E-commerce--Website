! function(e) {
    ...
    var a = function(a, n) {
      var r, i, o, s, d, l, p, c, u, f = {},
        ...
        q = function(e) {
          y && (e && (p = Math.max(g, Math.min(3, p + e))), y.find(".datepicker > div").hide().filter(".datepicker-" + w[p].clsName).show())
        },
        B = function(t, a) {
        ...
        R = function() {
          ...
          }(), y.find(".timepicker-hours").hide(), y.find(".timepicker-minutes").hide(), y.find(".timepicker-seconds").hide(), F(), q(), e(window).on("resize", H), y.on("click", "[data-action]", Z), y.on("mousedown", !1), m && m.hasClass("btn") && m.toggleClass("active"), H(), y.show(), n.focusOnShow && !o.is(":focus") && o.focus(), I({
            type: "dp.show"
          }), f)
        },
        Q = function() {
      ...
      if (f.destroy = function() {
          W(), o.off({
            ...
            focus: R
          }) : m && (m.off("click", Q), m.off("mousedown", !1)), a.removeData("DateTimePicker"), a.removeData("date")
      ...
      return r = M(), i = r.clone(), e.extend(!0, n, (u = {}, (c = a.is("input") || n.inline ? a.data() : a.find("input").data()).dateOptions && c.dateOptions instanceof Object && (u = e.extend(!0, u, c.dateOptions)), e.each(n, function(e) {
        ...
        focus: R
      }) : m && (m.on("click", Q), m.on("mousedown", !1)), o.prop("disabled") && f.disable(), o.is("input") && 0 !== o.val().trim().length ? L(N(o.val().trim())) : n.defaultDate && void 0 === o.attr("placeholder") && L(n.defaultDate), n.inline && R(), f
    };
